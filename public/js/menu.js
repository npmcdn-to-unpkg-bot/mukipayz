...
(function() {
    ...
    function showMenu(e) {
        ...
        var UserInfo = document.createElement('div');
          UserInfo.className = "btn btn-primary btn-block btn-lg";
          UserInfo.innerHTML = "Update User Info";
          UserInfo.addEventListener('click', handleToUserInfo);
        ...
        menuInner.appendChild(UserInfo);
    ...
    function handleToUserInfo() {
        window.location.assign('/home/userUpdate');
    }
